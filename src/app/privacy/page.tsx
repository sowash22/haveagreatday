...
export const metadata: Metadata = {
  title: "Privacy",
  description: "How Have a Great Day handles city searches, rounded coordinates, local preferences, forecast wording, and photo requests.",
};
    ...
    <>
      ...
      <main id="main" className="page-shell privacy-page">
        ...
        <section>
          ...
          <p>A city search is sent to Open-Meteo’s geocoding service. After you choose a result or permit browser location access, coordinates are rounded to two decimal places before they are sent to Open-Meteo’s weather and air-quality services. The selected place name, day, and three summarized forecast windows are sent to our inference service so it can phrase the recommendation. Coordinates, recent-place history, and device data are not included in that wording request. Some background photos load directly from Unsplash’s image service, which receives the ordinary request information needed to deliver and count a photo view. Your searched coordinates are not included in the photo URL.</p>
        </section>
        <section>
